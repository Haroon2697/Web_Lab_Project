...
const COUNTRY_INFO: Record<string, { flag: string; capital: string; region: string; population: string; fun: string }> = {
...
const BASE_SCORE: Record<string, number> = { easy: 100, medium: 200, hard: 300 }
