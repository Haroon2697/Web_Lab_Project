...
- Project proposal (PDF) and printed requirements  
- Figma / UI flow exports  
- API contract notes (endpoints, request/response shapes)  
- ER diagram or architecture sketches  
